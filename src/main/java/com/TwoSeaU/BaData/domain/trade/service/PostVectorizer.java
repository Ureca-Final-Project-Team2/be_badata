...
public class PostVectorizer {
    ...
    private double[] postCategoryVectorize(GifticonCategory category) {
        final double[] vector = new double[PostVectorizer.categoryToIndex.size()];

        final Integer index = PostVectorizer.categoryToIndex.get(category.getCategoryName());
    ...
    private double[] postPartnerVectorize(String partner) {
        final double[] vector = new double[PostVectorizer.partnerToIndex.size()];

        final Integer index = PostVectorizer.partnerToIndex.get(partner);
